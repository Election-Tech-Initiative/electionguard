...
Voters were able to confirm that their vote was counted by scanning their confirmation code on Enhanced Voting's [Ballot Lookup website](https://www.egvote.us/cc/id/22). If applicable, they could also see if their BallotChecks were included.  
...
??? abstract "How were the votes counted?"
     The jurisdiction counted all of the ballots and announced the official results as usual. The ElectionGuard pilot data was compared to the official results as part of testing the new technology.
??? abstract "What made the pilot a success?"
     ...
     * ElectionGuard did not interfere with existing election procedures 
     ...
     * Helped ensure that the technology is working correctly, with a goal of 1% of voters running a BallotCheck 
...
[encrypt-image-2]: ../../images/electionguard-logo.png 